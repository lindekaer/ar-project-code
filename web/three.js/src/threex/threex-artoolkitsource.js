  ...
  function setParameters(parameters) {
    ...
    for (var key in parameters) {
      ...
      if (newValue === undefined) {
        console.warn(
          "THREEx.ArToolkitSource: '" + key + "' parameter is undefined."
        )
        continue
      }
    ...
    .then(function(devices) {
      ...
      navigator.mediaDevices
        ...
        .then(function success(stream) {
          ...
          window.AR_EXPERIMENT.cameraOpened = Date.now()
...
ARjs.Source.prototype.onResizeElement = function(mirrorDomElements) {
  ...
  if (mirrorDomElements instanceof Array === false)
    mirrorDomElements = [mirrorDomElements]
