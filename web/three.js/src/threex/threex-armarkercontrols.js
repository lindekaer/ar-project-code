...
THREEx.ArMarkerControls.prototype = Object.create(
 ...
 */
THREEx.ArMarkerControls.prototype.updateWithModelViewMatrix = function(
  modelViewMatrix
) {
  ...
  if (!AR_EXPERIMENT.dataPoints.markerFound) {
    AR_EXPERIMENT.dataPoints.markerFoundAfter = Date.now()
    AR_EXPERIMENT.markerFound = true
  }
}
...
THREEx.ArMarkerControls.prototype._initArtoolkit = function() {
  AR_EXPERIMENT.dataPoints.artoolkitStarted = Date.now()
  var _this = this
