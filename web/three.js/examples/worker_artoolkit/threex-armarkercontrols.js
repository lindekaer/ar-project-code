...
THREEx.ArMarkerControls = function(context, object3d, parameters) {
  ...
  this.parameters = {
    ...
    patternUrl:
      parameters.patternUrl !== undefined ? parameters.patternUrl : null,
    // value of the barcode - IIF type='barcode'
    barcodeValue:
      parameters.barcodeValue !== undefined ? parameters.barcodeValue : null,
  ...
  arController.addEventListener('getMarker', function(event) {
    ...
    function onMarkerFound() {
      ...
      if (_this.parameters.changeMatrixMode === 'modelViewMatrix') {
        ...
        _this.parameters.changeMatrixMode === 'cameraTransformMatrix'
      ) {
        var cameraTransformMatrix = new THREE.Matrix4().getInverse(
          modelViewMatrix
        )
