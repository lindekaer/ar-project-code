...
THREEx.ArToolkitContext = function(parameters) {
  ...
  this.parameters = {
    ...
    sourceType:
      parameters.sourceType !== undefined ? parameters.sourceType : 'webcam',
    // url of the source - valid if sourceType = image|video
    sourceUrl: parameters.sourceUrl !== undefined ? parameters.sourceUrl : null,
    // the mode of detection - ['color', 'color_and_matrix', 'mono', 'mono_and_matrix']
    detectionMode:
      parameters.detectionMode !== undefined
        ? parameters.detectionMode
        : 'color_and_matrix',
    // type of matrix code - valid iif detectionMode end with 'matrix' - [3x3, 3x3_HAMMING63, 3x3_PARITY65, 4x4, 4x4_BCH_13_9_3, 4x4_BCH_13_5_5]
    matrixCodeType:
      parameters.matrixCodeType !== undefined
        ? parameters.matrixCodeType
        : '3x3',

    // url of the camera parameters
    cameraParametersUrl:
      parameters.cameraParametersUrl !== undefined
        ? parameters.cameraParametersUrl
        : THREEx.ArToolkitContext.baseURL + 'parameters/camera_para.dat',

    // tune the maximum rate of pose detection in the source image
    maxDetectionRate:
      parameters.maxDetectionRate !== undefined
        ? parameters.maxDetectionRate
        : 60,

    // resolution of at which we detect pose in the source image
    imageWidth:
      parameters.imageWidth !== undefined ? parameters.imageWidth : 640,
    imageHeight:
      parameters.imageHeight !== undefined ? parameters.imageHeight : 480,
    // resolution displayed for the source
    displayWidth:
      parameters.displayWidth !== undefined ? parameters.displayWidth : 640,
    displayHeight:
      parameters.displayHeight !== undefined ? parameters.displayHeight : 480
  }
...
THREEx.ArToolkitContext.prototype.initSource = function(onReady) {
  AR_EXPERIMENT.dataPoints.initMediaSource = Date.now()
  var _this = this
  ...
  function onSourceReady() {
    ...
    _this._onSourceReady(function onCompleted() {
      AR_EXPERIMENT.dataPoints.mediaSourceReady = Date.now()
...
THREEx.ArToolkitContext.prototype._onSourceReady = function(onCompleted) {
  ...
  _this.cameraParameters = new ARCameraParam(
