...
AFRAME.registerComponent('arjs-anchor', {
  ...
  init: function() {
    ...
    var timerId = setInterval(function() {
      ...
      var arAnchor = (_this._arAnchor = new ARjs.Anchor(
        arSession,
        arProfile.defaultMarkerParameters
      ))
  ...
  tick: function() {
    ...
    arWorldRoot.matrixWorld.decompose(
    ...
    if (_this._arAnchor.parameters.changeMatrixMode === 'modelViewMatrix') {
      ...
      _this._arAnchor.parameters.changeMatrixMode === 'cameraTransformMatrix'
    ) {
